...
namespace Normal.Realtime.Examples {
    public class HoverbirdPlayer : MonoBehaviour {
        ...
        private void RotateCamera() {
            ...
            _mouseLookX += lookInput.x * 0.1f;
            _mouseLookY += lookInput.y * 0.1f;
        ...
        private void CalculateTargetMovement() {
            ...
            inputMovement.x = moveInput.x * 6.0f;
            inputMovement.z = moveInput.y * 6.0f;
        ...
        private void CheckForJump() {
            ...
            if (Keyboard.current.spaceKey.wasPressedThisFrame && !_jumping)
                _jumpThisFrame = true;
        }
